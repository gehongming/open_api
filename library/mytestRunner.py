...
# from unittestreport.core.testResult import ReRunResult
from library.myresult import MyResult, MyReRunResult
from unittestreport.core.resultPush import DingTalk, WeiXin, SendEmail
...
class TestRunner():
    ...
    def run(self, thread_count=1, count=0, interval=2):
        ...
        with ThreadPoolExecutor(max_workers=thread_count) as ts:
            for i in suites:
                # res = TestResult()
                res = MyReRunResult(count=count, interval=interval)
